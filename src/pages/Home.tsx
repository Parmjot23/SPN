    ...
    <>
      ...
      <Section>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          ...
          <div className="flex flex-col items-center gap-2">
            <Package className="text-darkBg2" />
            <p className="text-3xl font-bold text-primary">
          ...
          <div className="flex flex-col items-center gap-2">
            <CheckCircle className="text-darkBg2" />
            <p className="text-3xl font-bold text-primary">
          ...
          {[
            {
              title: 'LTL Shipping',
              slug: 'ltl',
              icon: <Package className="w-10 h-10 text-darkBg2" />,
            },
            {
              title: 'FTL Shipping',
              slug: 'ftl',
              icon: <Truck className="w-10 h-10 text-darkBg2" />,
            },
            {
              title: 'Refrigerated Transport',
              slug: 'refrigerated',
              icon: <Snowflake className="w-10 h-10 text-darkBg2" />,
            },
          ].map((service) => (
            <Card
              key={service.slug}
