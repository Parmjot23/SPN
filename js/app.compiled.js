(() => {
  ...
  var Hero = () => {
    ...
    return /* @__PURE__ */ React.createElement("section", { className: "bg-gradient-to-br from-blue-700 via-blue-500 to-blue-700 h-96 flex items-center justify-center" }, /* @__PURE__ */ React.createElement("h1", { id: "heroText", className: "text-white text-4xl font-bold bg-black bg-opacity-50 p-4 rounded" }, "SPN Logistics"));
  };
  ...
  var NavLink = ({ to, children }) => /* @__PURE__ */ React.createElement(
    Link,
    {
  ...
  var Layout = ({ children }) => {
    ...
    const Links = () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(NavLink, { to: "/" }, "Home"), /* @__PURE__ */ React.createElement(NavLink, { to: "/about" }, "About"), /* @__PURE__ */ React.createElement(NavLink, { to: "/services" }, "Services"), /* @__PURE__ */ React.createElement(NavLink, { to: "/fleet" }, "Fleet"), /* @__PURE__ */ React.createElement(NavLink, { to: "/careers" }, "Careers"), /* @__PURE__ */ React.createElement(NavLink, { to: "/contact" }, "Contact"));
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("nav", { className: "sticky top-0 z-50 bg-white/80 backdrop-blur shadow-md" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-6xl mx-auto flex items-center justify-between p-4" }, /* @__PURE__ */ React.createElement("h1", { className: "text-xl font-bold" }, "SPN Logistics"), /* @__PURE__ */ React.createElement("button", { className: "md:hidden", onClick: toggle, "aria-label": "Menu" }, /* @__PURE__ */ React.createElement(
      "svg",
      {
        className: "w-6 h-6",
        fill: "none",
